...
raptor = RaptorAlgorithm()
grid_rapt = TransitGrid(grid_size, express_chance=express_chance, random_bus_start=True, seed=random.randint(0, 100000), n_stations=n_stations)
run_algo(raptor, grid_rapt)
sys.exit(0)
